...
@pytest.mark.skip
@pytest.mark.asyncio
async def test_list_profiles(client, pop_udb):
    roger_edi_id = 'EDI-cfc6ddd2c43849559f0186331c44faac'
    token = await tests.utils.create_test_pasta_token(roger_edi_id, pop_udb)
    print(token)
    # profile_row = pop_udb.get_profile(user_edi_id)
...
#
#
# def test_profile_disable(client, pop_udb):
#     token = tests.util.create_test_pasta_token(
#         'EDI-61b8b8872c13469faf4a44e3ff50b848', pop_udb
#     )
...
#
#
# def test_identity_drop(client, pop_udb):
#     token = tests.util.create_test_pasta_token(
#         'EDI-c422bd31545b4d7080a84ef1ba4a6a67', pop_udb
#     )
#     response = client.post(
#         '/v1/identity/drop',
#         params={
...
#
#
# def test_identity_list(client, pop_udb):
#     token = tests.util.create_test_pasta_token(
#         'EDI-61b8b8872c13469faf4a44e3ff50b848', pop_udb
#     )
